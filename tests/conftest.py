...
def auth_account_helper_fxt(mailhog_api_fxt):
    ...
    # TODO: replace hardcoded values with more flexible logic or remove this fixture since there is registered_auth_account_helper_fxt
...
def registered_auth_account_helper_fxt(mailhog_api_fxt):
    user = _get_user_data()
