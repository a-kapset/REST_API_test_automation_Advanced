...
class TestsGetV1AccountPositive:
    ...
    async def test_get_v1_account_authenticated(self, account_helper_auth_existing_fxt: AccountHelper) -> None:
    ...
    async def test_get_v1_account_check_properties(self, account_helper_auth_existing_fxt: AccountHelper) -> None:
...
class TestsGetV1AccountNegative:
    ...
    async def test_get_v1_account_not_authenticated(self, account_helper_fxt: AccountHelper) -> None:
